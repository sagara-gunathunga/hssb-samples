...
public class BookclubConfiguration {
    ...
    @Bean
    public BookService bookService(BookRepository bookRepository, BookCopyRepository bookCopyJPARepository, CommentRepository commentRepository) {
        return new BookServiceImpl(bookRepository, bookCopyJPARepository, commentRepository);
    }
}
